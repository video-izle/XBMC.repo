# -*- coding: utf-8 -*-
#------------------------------------------------------------
# XBMC Add-on for http://www.youtube.com/user/UCPs5KKWyk7udVVAuurd_fZA
# Version 1.0.2
#------------------------------------------------------------
...
YOUTUBE_CHANNEL_ID = "UCPs5KKWyk7udVVAuurd_fZA"

# Entry point
def run():
    plugintools.log("UCPs5KKWyk7udVVAuurd_fZA.run")
