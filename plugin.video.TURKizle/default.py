...
def main():
    add_video_item(' rtmp://188.40.139.202:1935/ek/_definst_/fox.stream ',{ 'title': ' FOX TV '}, icons + '195.png')
    add_video_item('http://mn-l.mncdn.com/showtv/showtv2/playlist.m3u8',{ 'title': ' SHOW HD '}, icons + '96.png')
    ...
    add_video_item('http://212.224.108.76:80/S1/HLS_LIVE/taksim/1000/prog_index.m3u8',{ 'title': ' YESILCAM TV '}, icons + '1.png')	
